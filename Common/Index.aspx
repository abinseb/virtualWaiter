                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <div class="buttons">
                   					<button type="button" class="btn btn-style-white btn-style-primary mt-lg-5 mt-2" data-toggle="modal"
				...
				<div class="modal-body">
					<form action="#" method="post" class="p-3">
						<div class="form-group">
							Username<asp:TextBox ID="txtuserid" class="form-control" 
                                placeholder="Email Address" runat="server"></asp:TextBox>
						  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtuserid" ErrorMessage="Plz enter your Email/Username" 
                    ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="txtuserid" ErrorMessage="plz type a valid email" 
                    ForeColor="Red" 
                    ...
                    ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                          <asp:Label ID="lib" runat="server" ForeColor="Red"></asp:Label>
							</div>
                       
						<div class="right-w3l mt-4 mb-3">
                             <asp:Button ID="Button1" runat="server" class="btn btn-style-white btn-style-primary mt-lg-5 mt-2" 
                                 onclick="Button1_Click" Text="Login" Width="120px" />
						</div>
                        <div class="right-w3l mt-4 mb-3">
						</div>
					</form>
